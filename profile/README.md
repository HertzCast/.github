...
<p align="center">
  <img src="https://raw.githubusercontent.com/HertzCast/hertzcast.github.io/v2.2.1/screenshots/UI%201.png" height="420" alt="Main UI — Net Radio Now Playing" />
  &nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/HertzCast/hertzcast.github.io/v2.2.1/screenshots/UI%206.png" width="280" alt="Menu Bar Mini Player" />
</p>
...
| 🎚️ **Volume Knob** | Metallic rotating knob — drag in a circle or use the scroll wheel |
| 🎵 **Transport Controls** | Play, pause, stop, skip, shuffle, repeat — adapts to active source |
| 📡 **Net Radio & Favourites** | Full directory browser, save favourites, view recently played |
| ⏰ **Scheduling** | Morning Alarm, Auto Off, Sleep Timer — fires even after Mac sleep |
| 🔊 **Zone 2** | Independent power, input, volume and mute for a second audio zone |
| 🎛️ **Audio Tuning** | Bass, treble, subwoofer, Pure Direct, Enhancer, full sound programs |
| ☰ **Menu Bar Mini Player** | Playback and volume from the menu bar — no need to open the app |
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/HertzCast/hertzcast.github.io/v2.2.1/screenshots/UI%204.png" height="400" alt="Settings" />
  &nbsp;&nbsp;
  <img src="https://raw.githubusercontent.com/HertzCast/hertzcast.github.io/v2.2.1/screenshots/UI%202.png" height="400" alt="Music Center" />
</p>
